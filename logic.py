...
class DB_Manager:
    ...
    def insert_project(self, data):
        sql = """INSERT INTO projects 
                ...
                values(?, ?, ?, ?)""" # Masukkan kueri SQL yang benar di sini
        self.__executemany(sql, data)
    ...
    def get_statuses(self):
        sql = "SELECT status_name from status" # Masukkan kueri SQL yang benar di sini
    ...
    def get_projects(self, user_id):
        sql = """SELECT * FROM projects
                WHERE user_id = ?""" # Masukkan kueri SQL yang benar di sini
...
if __name__ == '__main__':
    ...
    manager.insert_project([(1, 'Project A', 'http://example.com', 1)])